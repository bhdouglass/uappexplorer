    ...
    return (
      <Modal show={this.props.show} onHide={this.props.onHide}>
        ...
        <Modal.Body>
          ...
          <h4>{i18n.t('Buy the Webapp')}</h4>
          <div>
            <Link to="/app/uappexplorer-donate.bhdouglass" onClick={this.props.onHide}>
              {i18n.t('Buy the webapp from the Ubuntu Touch app store')}
            </Link>
            <br/>
            <Link to="/app/uappexplorer.bhdouglass" onClick={this.props.onHide}>
              {i18n.t("(Don't worry, there is a free version too!)")}
            </Link>
          </div>
          ...
          <h4>{i18n.t('Donate via Gratipay')}</h4>
          <div>
